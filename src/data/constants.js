...
export const MILESTONES = [
  ...
  { id: 'foundation_complete', label: 'Foundation Complete', trigger: 'Foundation Cure', pct: 8, short: 'FND' },
  ...
  { id: 'rough_complete', label: 'Rough Complete', trigger: null, pct: 45, short: 'RGH' },
  { id: 'drywall_complete', label: 'Drywall Complete', trigger: 'Drywall Finish', pct: 55, short: 'DRW' },
  { id: 'trim_complete', label: 'Trim Complete', trigger: 'Trim', pct: 75, short: 'TRM' },
  { id: 'final_inspection', label: 'Final Inspection', trigger: 'Final Clean', pct: 95, short: 'FIN' },
